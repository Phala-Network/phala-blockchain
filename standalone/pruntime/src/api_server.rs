...
fn rpc_type(method: &str) -> RpcType {
    ...
    match PhactoryAPIMethod::from_str(method) {
        ...
        Some(method) => match method {
            ...
            DcapHandoverCreateChallenge => Private,
            DcapHandoverStart => Private,
            DcapHandoverAcceptChallenge => Private,
            DcapHandoverReceive => Private,
...
fn default_payload_limit_for_method(method: PhactoryAPIMethod) -> ByteUnit {
    ...
    match method {
        ...
        DcapHandoverCreateChallenge => 10.kibibytes(),
        DcapHandoverStart => 10.kibibytes(),
        DcapHandoverAcceptChallenge => 10.kibibytes(),
        DcapHandoverReceive => 10.kibibytes(),
