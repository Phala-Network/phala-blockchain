...
fn store_erc20_burned_transactions_works() {
	new_test_ext().execute_with(|| {
		...
		let tx_hash = EthereumTxHash(hex!["9c944a0627a9032489f0673246d1f272032f47d29857500ddb7e891c1287079a"]);
		...
		assert_eq!(BurnedTransactions::<Test>::get(&tx_hash), (eth_addr, 100));
	});
}
