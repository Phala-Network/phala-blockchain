...
pub mod messaging {
    ...
    /// A fixed point number with 116 integer bits and 12 fractional bits.
    pub type U116F12Bits = u128;
    ...
    pub enum WorkerEvent {
        ...
        MiningStart { session_id: u32, init_v: U116F12Bits },
        /// pallet-mining --> worker
