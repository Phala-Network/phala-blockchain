...
fn load_spec(
	...
	match id {
		...
		"fir" | "flaming-fir" => Ok(Box::new(chain_spec::flaming_fir_config()?)),
		"" | "phala" | "phala_testnet" => Ok(Box::new(chain_spec::phala_testnet_config()?)),
		"phala-local" | "phala_testnet-local" => Ok(Box::new(chain_spec::phala_testnet_local_config())),
		"staging" => Ok(Box::new(chain_spec::staging_testnet_config())),
		"collator" => Ok(Box::new(chain_spec::parachain_testnet_config(para_id))),
